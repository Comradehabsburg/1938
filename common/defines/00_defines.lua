...
NGame = {
	...
	CHECKSUM_SALT = "zwOdv5d9wmGumbis",				-- Data to modify generated checksum when game binaries have changed but not any content files.
	...
	GAME_SPEED_SECONDS = { 2.0, 0.5, 0.2, 0.05, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound -- old values : 2.0, 0.5, 0.2, 0.1, 0.0
...
NCountry = {
	...
	SPECIAL_FORCES_CAP_MIN = 336,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NMilitary = {
	...
	BASE_COMBAT_WIDTH = 999999,                        -- base combat width
